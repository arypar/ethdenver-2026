...
import type { ChartConfig, Metric, TimeRange, ChartType } from '@/lib/types';

const METRICS: Metric[] = ['Price', 'Volume', 'Fees', 'Swap Count'];
...
export function ChartForm({ config, onChange, onGenerate, loading }: ChartFormProps) {
  return (
    <div className="flex flex-col gap-3">
      <div className="flex flex-wrap items-end gap-3">
        ...
        <Button className="h-9 rounded-xl px-4 text-[13px] font-semibold" onClick={onGenerate} disabled={loading || !config.pool.includes('/')}
